...
fn input_help_mentions_flags_and_steps() {
    Command::new(env!("CARGO_BIN_EXE_xtask"))
        ...
        .stdout(predicate::str::contains("hid_mouse_report_generation"))
        ...
        .stdout(predicate::str::contains("--test xhci_topology"))
        .stdout(predicate::str::contains("--test xhci_step_frames_clamp "))
        .stdout(predicate::str::contains("--test xhci_step_frames_clamping"))
        .stdout(predicate::str::contains("xhci_bme_event_ring"))
        .stdout(predicate::str::contains("--test xhci_webusb_snapshot"))
        .stdout(predicate::str::contains("--test xhci_snapshot"))
        ...
        .stdout(predicate::str::contains("src/usb/usb_broker.test.ts"))
        .stdout(predicate::str::contains(
            "src/usb/usb_broker_subport.test.ts",
        ))
        .stdout(predicate::str::contains("src/usb/usb_broker_panel.test.ts"))
        ...
        .stdout(predicate::str::contains("src/usb/webusb_panel.test.ts"))
        .stdout(predicate::str::contains(
        ...
        .stdout(predicate::str::contains("src/usb/hid_report_ring.test.ts"))
        .stdout(predicate::str::contains(
        ...
        .stdout(predicate::str::contains("usb2_port_mux_speed"))
        ...
        .stdout(predicate::str::contains("webhid_boot_interface"))
        .stdout(predicate::str::contains("--test webhid_passthrough"))
        .stdout(predicate::str::contains(
            "--test webhid_report_descriptor_synthesis",
        ))
        .stdout(predicate::str::contains("xhci_enum_smoke"))
        .stdout(predicate::str::contains("xhci_port_remote_wakeup"))
