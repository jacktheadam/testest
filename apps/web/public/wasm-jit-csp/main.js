...
// Served from `public/`, so this resolves against the URL, not the filesystem: a path out to
// `packages/` leaves whatever root is serving this page. The generated copy under
// `public/_shared/` exists for exactly this, and the other public assets use it too.
...
// Used by `encodeString` below, which had referenced it without ever declaring it — so the first
// call reaching that path threw `textEncoder is not defined`, which is the whole of what this
// page's bytecode-to-wasm compiler does.
