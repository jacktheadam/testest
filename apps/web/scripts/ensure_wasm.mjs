...
// Three levels: this file sits in `apps/web/scripts/`. It had been two, which landed on
// `apps/` and made the wasm paths right only because "apps/web/src/wasm" was appended to it.
...
export function ensureVariant(variant) {
    const outDirAero = path.join(repoRoot, "apps/web/src/wasm", variant === "threaded" ? "pkg-threaded" : "pkg-single");
