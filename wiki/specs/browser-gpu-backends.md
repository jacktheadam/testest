# Browser GPU backends

> Presentation targets WebGPU first and falls back to WebGL2. This page
> specifies backend selection, the worker and OffscreenCanvas lifecycle,
> capability negotiation, the presentation path, device-loss recovery, and the
...
[12-testing-strategy.md](../areas/testing.md#browser-testing).
