...
- [`wiki/areas/drivers-windows.md`](wiki/areas/drivers-windows.md) — covers how the unattended-install plumbing works, how to validate/debug on a real VM install, and end-to-end install media preparation (WIM/BCD/certs + ISO rebuild)
