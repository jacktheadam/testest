...
// BAR0 size in the Aero Windows 7 virtio contract v1 (see the Windows guest drivers area page#the-aero-w7-virtio-device-contract-v1).
...
export class VirtioNetPciDevice implements PciDevice, TickableDevice {
  ...
  initPciConfig(config: Uint8Array): void {
    ...
    //
    // Layout is fixed by `the Windows guest drivers area page#transport-modern-only`:
