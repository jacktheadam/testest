...
import { AerogpuFormat } from "../../crates/aero-protocol/aerogpu/aerogpu_pci";
...
async function main() {
  ...
  try {
    ...
    // Program a synthetic AeroGPU cursor image into guest RAM and simulate the MMIO writes the
    ...
    if (cursorRamOff + 4 > guestU8.byteLength) {
      throw new Error("Cursor buffer is out of bounds.");
    }
