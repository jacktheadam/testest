...
#[test]
fn aerogpu_intx_is_gated_on_pci_command_intx_disable() {
    ...
    assert_ne!(
        ...
        0,
        "sanity: fence IRQ should have latched in IRQ_STATUS"
    );

    // Polling should *not* surface a pending PIC vector while COMMAND.INTX_DISABLE is set.
