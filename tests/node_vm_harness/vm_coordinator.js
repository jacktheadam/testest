...
import { ErrorCode, serializeError } from '../../apps/web/src/errors.js';
import { createCustomEvent } from '../../apps/web/src/custom_event.js';
...
export class VmCoordinator extends EventTarget {
  constructor({ config = {}, workerUrl = new URL('./cpu_worker.js', import.meta.url) } = {}) {
    super();
