...
function tryWriteResponse(res, statusCode, headers, body) {
  try {
...
function sendJsonNoStore(res, statusCode, value, opts) {
  let code = statusCode;
...
function sendTextNoStore(res, statusCode, body, opts) {
...
export { tryWriteResponse, sendJsonNoStore, sendTextNoStore };
