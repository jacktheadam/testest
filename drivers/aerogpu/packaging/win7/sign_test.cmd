...
if not "%ERRORLEVEL%"=="0" (
  ...
  echo [ERROR]   pwsh drivers/build/install-wdk.ps1
  echo [ERROR]   pwsh drivers/build/build-drivers.ps1 -ToolchainJson out/toolchain.json -Drivers aerogpu
  echo [ERROR]   pwsh drivers/build/build-aerogpu-dbgctl.ps1 -ToolchainJson out/toolchain.json
  echo [ERROR]   pwsh drivers/build/make-catalogs.ps1 -ToolchainJson out/toolchain.json
  echo [ERROR]   pwsh drivers/build/sign-drivers.ps1 -ToolchainJson out/toolchain.json
  exit /b 1
)
exit /b 0
