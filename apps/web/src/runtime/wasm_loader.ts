...
export interface WasmApi {
    ...
    /**
     * Guest RAM layout contract (see `wiki/decisions/0003-shared-memory-layout.md`).
     *
...
// `wasm-pack` outputs into `apps/web/src/wasm/pkg-single` and `apps/web/src/wasm/pkg-threaded`.
//
