...
// Two levels: this file lives in `tests/helpers/`, so one `..` only reaches `tests/`.
// It had been one, which pointed every asset path at a directory that has never existed.
