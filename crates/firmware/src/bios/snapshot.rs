...
impl BiosSnapshot {
    pub fn encode<W: Write>(&self, w: &mut W) -> std::io::Result<()> {
        ...
        w.write_all(&[4])?;
        let boot_order_len: u8 = self.config.boot_order.len().try_into().unwrap_or(u8::MAX);
...
impl Bios {
    pub fn snapshot(&self) -> BiosSnapshot {
        BiosSnapshot {
            ...
            el_torito_boot_info: self
                .el_torito_boot_info
                .map(|info| ElToritoBootInfoSnapshot {
...
mod tests {
    ...
    fn bios_snapshot_decode_truncates_tty_output_to_a_rolling_tail_window() {
        ...
        assert_eq!(
            decoded.tty_output[0],
            ((total - MAX_TTY_OUTPUT_BYTES) % 256) as u8
        );
        assert_eq!(
            decoded.tty_output[decoded.tty_output.len() - 1],
            ((total - 1) % 256) as u8
        );
    }
    ...
    const PRE_BOOT_ORDER_EXT_SNAPSHOT: &[u8] = &[
        ,
