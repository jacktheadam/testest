#!/usr/bin/env python3
"""
Regenerate or check artifacts derived from `protocol-vectors/windows-device-contract.json`.
...
ARTIFACTS: tuple[Artifact, ...] = (
    ...
    Artifact(
        path=REPO_ROOT / "protocol-vectors/windows-device-contract-virtio-win.json",
