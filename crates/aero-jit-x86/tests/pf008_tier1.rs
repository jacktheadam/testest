...
const RETURN_SENTINEL_RIP: u64 = 0xdead_beef_cafe_babe;
...
fn run_pf008_payload_64(
    ...
    backend.write(STACK_RSP, Width::W64, RETURN_SENTINEL_RIP);
    if needs_scratch {
...
#[test]
fn pf008_alu64_checksum_tier1_jit() {
    let code = [
        0x48, 0xb8, 0xf0, 0xde, 0xbc, 0x9a, 0x78, 0x56, 0x34, 0x12, 0x48, 0xba, 0x15, 0x7c, 0x4a,
        0x7f, 0xb9, 0x79, 0x37, 0x9e, 0x48, 0x01, 0xd0, 0x48, 0x89, 0xc3, 0x48, 0xc1, 0xeb, 0x0d,
        0x48, 0x31, 0xd8, 0x48, 0xd1, 0xe0, 0x48, 0xff, 0xc9, 0x75, 0xeb, 0xc3,
    ];
    run_pf008_payload_64("alu64", &code, 0xf935_f948_2b8f_99b8, false);
}

#[test]
fn pf008_branch_pred64_checksum_tier1_jit() {
    let code = [
        0x48, 0xb8, 0xf0, 0xde, 0xbc, 0x9a, 0x78, 0x56, 0x34, 0x12, 0x48, 0xbb, 0x15, 0x7c, 0x4a,
        0x7f, 0xb9, 0x79, 0x37, 0x9e, 0x48, 0x31, 0xd2, 0x75, 0x03, 0x48, 0x01, 0xd8, 0x48, 0x31,
        0xd2, 0x75, 0x03, 0x48, 0x31, 0xd8, 0x48, 0xd1, 0xe0, 0x48, 0x83, 0xc0, 0x01, 0x48, 0xff,
        0xc9, 0x75, 0xe4, 0xc3,
    ];
    run_pf008_payload_64("branch_pred64", &code, 0xd7ab_5d5a_aad6_afab, false);
}

#[test]
fn pf008_branch_unpred64_checksum_tier1_jit() {
    let code = [
        0x48, 0xb8, 0xf0, 0xde, 0xbc, 0x9a, 0x78, 0x56, 0x34, 0x12, 0x48, 0xbb, 0x08, 0x09, 0x0a,
        0x0b, 0x0c, 0x0d, 0x0e, 0x0f, 0x48, 0x89, 0xc2, 0x48, 0xc1, 0xe2, 0x0d, 0x48, 0x31, 0xd0,
        0x48, 0x89, 0xc2, 0x48, 0xc1, 0xea, 0x07, 0x48, 0x31, 0xd0, 0x48, 0x89, 0xc2, 0x48, 0xc1,
        0xe2, 0x11, 0x48, 0x31, 0xd0, 0x48, 0x89, 0xc2, 0x48, 0x83, 0xe2, 0x01, 0x74, 0x05, 0x48,
        0x01, 0xc3, 0xeb, 0x05, 0x48, 0x31, 0xc3, 0xeb, 0x00, 0x48, 0xff, 0xc9, 0x75, 0xca, 0x48,
        0x89, 0xd8, 0xc3,
    ];
    run_pf008_payload_64("branch_unpred64", &code, 0xdf14_f128_b035_d3f0, false);
}

#[test]
fn pf008_mem_seq64_checksum_tier1_jit() {
    let code = [
        0x48, 0xb8, 0xef, 0xcd, 0xab, 0x89, 0x67, 0x45, 0x23, 0x01, 0x48, 0x31, 0xf6, 0x48, 0x8b,
        0x14, 0x37, 0x48, 0x01, 0xd0, 0x48, 0x31, 0xc2, 0x48, 0x89, 0x14, 0x37, 0x48, 0x83, 0xc6,
        0x08, 0x48, 0x81, 0xe6, 0xff, 0x0f, 0x00, 0x00, 0x48, 0xff, 0xc9, 0x75, 0xe2, 0xc3,
    ];
    run_pf008_payload_64("mem_seq64", &code, 0xb744_7613_0686_5560, true);
}

#[test]
fn pf008_mem_stride64_checksum_tier1_jit() {
    let code = [
        0x48, 0xb8, 0xef, 0xcd, 0xab, 0x89, 0x67, 0x45, 0x23, 0x01, 0x48, 0x31, 0xf6, 0x48, 0x8b,
        0x14, 0x37, 0x48, 0x01, 0xd0, 0x48, 0x31, 0xc2, 0x48, 0x89, 0x14, 0x37, 0x48, 0x83, 0xc6,
        0x40, 0x48, 0x81, 0xe6, 0xff, 0x0f, 0x00, 0x00, 0x48, 0xff, 0xc9, 0x75, 0xe2, 0xc3,
    ];
    run_pf008_payload_64("mem_stride64", &code, 0xd8d5_ee9d_0da7_ebb4, true);
}

#[test]
fn pf008_call_ret64_checksum_tier1_jit() {
    let code = [
        0x48, 0xb8, 0xef, 0xbe, 0xfe, 0xca, 0xce, 0xfa, 0xed, 0xfe, 0x48, 0xbb, 0x15, 0x7c, 0x4a,
        0x7f, 0xb9, 0x79, 0x37, 0x9e, 0xe8, 0x06, 0x00, 0x00, 0x00, 0x48, 0xff, 0xc9, 0x75, 0xf6,
        0xc3, 0x53, 0x56, 0x48, 0x01, 0xd8, 0x48, 0x35, 0xb5, 0x3b, 0x12, 0x1f, 0x48, 0xc1, 0xe0,
        0x03, 0x5e, 0x5b, 0xc3,
    ];
