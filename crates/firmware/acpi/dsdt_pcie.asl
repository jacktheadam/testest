/*
 * Clean-room DSDT for Aero (PCIe ECAM/MMCONFIG-enabled variant).
 *
 ...
 *
 *     iasl -d crates/firmware/acpi/dsdt_pcie.aml
 */

DefinitionBlock ("dsdt_pcie.aml", "DSDT", 2, "AERO  ", "AEROACPI", 0x00000001)
{
    Name (PICM, Zero)
    ...
    Scope (_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            Device (ISA)
            {
                ...
                /*
                 * These fixed devices consume resources produced by PCI0.
                 * Keeping them beneath the LPC bridge prevents sibling
                 * resource claims from conflicting with PCI0._CRS.
                 */
                Device (SYS0)
                {
