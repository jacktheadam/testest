import { AerogpuCmdWriter, AEROGPU_RESOURCE_USAGE_RENDER_TARGET } from "../../crates/aero-protocol/aerogpu/aerogpu_cmd";
import { AEROGPU_ABI_VERSION_U32, AerogpuFormat } from "../../crates/aero-protocol/aerogpu/aerogpu_pci";
import { AEROGPU_ALLOC_TABLE_MAGIC } from "../../crates/aero-protocol/aerogpu/aerogpu_ring";
import {
  FRAME_PRESENTED,
  FRAME_SEQ_INDEX,
  FRAME_STATUS_INDEX,
