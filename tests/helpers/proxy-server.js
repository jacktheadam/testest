...
import { socketWritableLengthExceedsCap } from "../../packages/transport-safety/src/socket_writable_length.js";
...
async function startProxyServer({
  ...
  const wss = new WebSocketServer({
    ...
    handleProtocols: (protocols) => {
      // Match the normative protocol requirement from wiki: L2 tunnel protocol.
